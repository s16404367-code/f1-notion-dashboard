...
export function createController({ store, client, mode }) {
	...
	// Worker for live latest + history interpolation
	const worker = new Worker("./src/worker/telemetryWorker.js", { type: "module" });
